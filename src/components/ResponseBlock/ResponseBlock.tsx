...
const ResponseBlock = () => {
    ...
    const responseHeaders = usePostmanStore(
        (state: PostmanState) => state.responseHeaders
    );
    const isLoading = usePostmanStore((state: PostmanState) => state.isLoading);

    const handleChangeTabsResponse = (
            ...
            <Box component='div' sx={styles.responseStatusBox}>
                <Box component='div' sx={styles.responseStatusItem}>
                    ...
                    <Box
                        ...
                        sx={
                            status.toString()[0] === '2'
                                ? styles.statusColorOk
                                : styles.statusColorError
                        }
                    >
                        {status}{' '}
                    </Box>
